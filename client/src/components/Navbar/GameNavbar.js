        ...
        <Navbar style={navbarStyle} fixed="top">
            <Container className="justify-content-between">
                ...
                <CustomButton>
                    ...
                    {turnTimeOut && <Countdown date={turnTimeOut} renderer={renderer} onComplete={handleTurnTimeout} />}
                </CustomButton>

                {/* Game Code */}
                <div style={gameCodeStyle}>
                    <span>GAME CODE: {gameCode}</span>
                    <Button onClick={() => copyToClipboard(gameCode)} style={copyButtonStyle}>
                        <img src={clipboard} alt="Copy to clipboard" style={{ width: "28px", height: "28px" }} />
                    </Button>
                </div>
